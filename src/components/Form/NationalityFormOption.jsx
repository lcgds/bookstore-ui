export function NationalityFormOption() {
    return (
        <>
            ...
            <option value="guinéu-equatoriano(a)">guinéu-equatoriano(a)</option>
            ...
            <option value="norte-irlandês(esa)">norte-irlandês(esa)</option>
            ...
            <option value="trinitário(a)-tobagense">trinitário(a)-tobagense</option>
